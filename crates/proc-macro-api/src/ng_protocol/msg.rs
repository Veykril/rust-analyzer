...
pub const CURRENT_API_VERSION: u32 = 0x1000;
...
pub enum C2SRequest {
    ...
    ExpandMacro { task: Box<ExpandMacro> },
    ApiVersionCheck {},
}

#[derive(Debug, Serialize, Deserialize)]
pub enum C2SResponse {}
...
pub enum S2CResponse {
    ...
    /// Since [`NO_VERSION_CHECK_VERSION`]
    ExpandMacro(Result<ExpandMacroExtended, PanicMessage>),
    /// Since [`NO_VERSION_CHECK_VERSION`]
    ApiVersionCheck(u32),
    Error(String),
}
...
impl Message for C2SPacket {}
impl Message for S2CResponse {}
