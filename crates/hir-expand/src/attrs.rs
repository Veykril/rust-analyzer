...
impl Attr {
    fn from_src(
        ...
        let input = if let Some(ast::Expr::Literal(lit)) = ast.expr() {
            ...
            let tree = syntax_node_to_token_tree(tt.syntax(), span_anchor, offset);
    ...
    fn from_tt(
        ...
        // Self::from_src(db, InFile { file_id: HirFileId::DUMMY, value: ast }, hygiene, id)
        todo!()
    }
