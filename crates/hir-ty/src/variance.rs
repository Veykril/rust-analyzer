...
"#,
            expect![[r#"
                Recursive[T: bivariant]
            "#]],
        );
        check(
            r#"
struct Recursive<T>(Recursive2<T>);
struct Recursive2<T>(Recursive<T>);
"#,
            expect![[r#"
                Recursive[T: bivariant]
                Recursive2[T: bivariant]
            "#]],
        );
        check(
            r#"
struct Recursive<T>(Recursive3<T>);
struct Recursive2<T>(Recursive<T>);
struct Recursive3<T>(Recursive2<T>);
"#,
            expect![[r#"
                Recursive[T: bivariant]
                Recursive2[T: bivariant]
                Recursive3[T: bivariant]
            "#]],
        );
    }
