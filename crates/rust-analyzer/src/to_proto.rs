...
use ide::{
    ...
    CompletionItemKind, CompletionRelevance, FileId, FileRange, FileSystemEdit, Fold, FoldKind,
    Highlight, HlMod, HlOperator, HlPunct, HlRange, HlTag, Indel, InlayHint, InlayKind, Markup,
...
pub(crate) fn documentation(documentation: hir::Documentation) -> lsp_types::Documentation {
