...
pub(super) fn binary_op_return_ty(op: BinaryOp, lhs_ty: TyKind, rhs_ty: TyKind) -> TyKind {
    match op {
        BinaryOp::LogicOp(_) | BinaryOp::CmpOp(_) => TyKind::Scalar(Scalar::Bool),
        BinaryOp::Assignment { .. } => TyKind::unit(),
...
pub(super) fn binary_op_rhs_expectation(op: BinaryOp, lhs_ty: TyKind) -> TyKind {
    match op {
        BinaryOp::LogicOp(..) => TyKind::Scalar(Scalar::Bool),
        ...
        BinaryOp::ArithOp(ArithOp::Shl) | BinaryOp::ArithOp(ArithOp::Shr) => TyKind::Unknown,
